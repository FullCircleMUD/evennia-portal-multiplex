"""
Settings for server3 — a Server attached to server1's Portal.

Usage, from the `server3/` directory:

    evennia server_start --settings settings_server3
